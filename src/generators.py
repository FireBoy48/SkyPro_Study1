...
def transaction_descriptions(transactions: list) -> Generator:
    ...
    :param transactions: База данных с транзакциями пользователей
    :return:  Итерируемый объект содержащий только descriptions
    """
    i = 0
...
def card_number_generator(start: int, end: int) -> Generator:
    ...
    :param end: Точка конца генерации
    :return: Строка номер карты в формате ХХХХ ХХХХ ХХХХ ХХХХ
    """
    while start != end + 1:
        result = str(start).rjust(16, "0")
